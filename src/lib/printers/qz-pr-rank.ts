    ...
    html += `
          ...
          <tfoot>
            <tr>
              ...
              <td style="padding: 8px 2px; text-align: right; font-weight: bold; border-top: 1px solid #000; font-size: 13px;">
                ${totalPriceSum.toLocaleString()} <span style="font-size: 10px; color: #555;">${mainCurrency}</span>
              </td>
            </tr>
          </tfoot>
        </table>
